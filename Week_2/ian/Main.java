            ...
            switch (a) {
                case 1:
                    System.out.println("Please type the BookID number for the book you"
                            + " wish to find.");
                    int b = scan.nextInt();
                    if ((0 < b) && (b <= dbm.BookDatabase.size())) {
                        dbm.searchForBook(b);
                        int g = scan.nextInt();
                        if (g == 1) {
                ...
                case 2:
                    System.out.println("Please type the BookID number for the book you"
                            + " wish to remove.");
                    int c = scan.nextInt();
                    if ((0 < c) && (c <= dbm.BookDatabase.size())) {
                ...
                case 3:
                    ...
                    if (scan.hasNextInt()) {
                        ...
                        dbm.addBookToDatabase(d, e, f);
                        System.out.println("Your book has been added and its ID number is "
                                + (dbm.BookDatabase.size()) + ". Type any positive number to "
                ...
                case 5:
                    ...
                    int g = scan.nextInt();
                    if ((0 < g) && (g <= dbm.BookDatabase.size())) {
                ...
                case 6:
                    ...
                    int h = scan.nextInt();
                    if ((0 < h) && (h <= dbm.BookDatabase.size())) {
